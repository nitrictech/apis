...
goog.exportSymbol('proto.nitric.resource.v1.DeadLetterResource', null, global);
 ...
 * @constructor
 */
proto.nitric.resource.v1.DeadLetterResource = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.nitric.resource.v1.DeadLetterResource, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.nitric.resource.v1.DeadLetterResource.displayName = 'proto.nitric.resource.v1.DeadLetterResource';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
 ...
 * @const
 */
proto.nitric.resource.v1.ResourceDeclareRequest.oneofGroups_ = [[10,11,12,13,14,15,16,17]];
...
proto.nitric.resource.v1.ResourceDeclareRequest.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    deadLetter: (f = msg.getDeadLetter()) && proto.nitric.resource.v1.DeadLetterResource.toObject(includeInstance, f)
  };
...
proto.nitric.resource.v1.ResourceDeclareRequest.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    case 16:
      ...
      break;
    case 17:
      var value = new proto.nitric.resource.v1.DeadLetterResource;
      reader.readMessage(value,proto.nitric.resource.v1.DeadLetterResource.deserializeBinaryFromReader);
...
proto.nitric.resource.v1.ResourceDeclareRequest.serializeBinaryToWriter = function(message, writer) {
  ...
  if (f != null) {
    writer.writeMessage(
      17,
      f,
      proto.nitric.resource.v1.DeadLetterResource.serializeBinaryToWriter
    );
  }
};
...
/**
 * optional DeadLetterResource dead_letter = 17;
 * @return {?proto.nitric.resource.v1.DeadLetterResource}
 */
proto.nitric.resource.v1.ResourceDeclareRequest.prototype.getDeadLetter = function() {
  return /** @type{?proto.nitric.resource.v1.DeadLetterResource} */ (
    jspb.Message.getWrapperField(this, proto.nitric.resource.v1.DeadLetterResource, 17));
};


/**
 * @param {?proto.nitric.resource.v1.DeadLetterResource|undefined} value
 * @return {!proto.nitric.resource.v1.ResourceDeclareRequest} returns this
*/
proto.nitric.resource.v1.ResourceDeclareRequest.prototype.setDeadLetter = function(value) {
  return jspb.Message.setOneofWrapperField(this, 17, proto.nitric.resource.v1.ResourceDeclareRequest.oneofGroups_[0], value);
};
 ...
 * @return {!proto.nitric.resource.v1.ResourceDeclareRequest} returns this
 */
proto.nitric.resource.v1.ResourceDeclareRequest.prototype.clearDeadLetter = function() {
  return this.setDeadLetter(undefined);
};
 ...
 * @return {boolean}
 */
proto.nitric.resource.v1.ResourceDeclareRequest.prototype.hasDeadLetter = function() {
 ...
 * @return {!Object}
 */
proto.nitric.resource.v1.DeadLetterResource.prototype.toObject = function(opt_includeInstance) {
  return proto.nitric.resource.v1.DeadLetterResource.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.nitric.resource.v1.DeadLetterResource} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.nitric.resource.v1.DeadLetterResource.toObject = function(includeInstance, msg) {
  var f, obj = {
 ...
 * @return {!proto.nitric.resource.v1.DeadLetterResource}
 */
proto.nitric.resource.v1.DeadLetterResource.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.nitric.resource.v1.DeadLetterResource;
  return proto.nitric.resource.v1.DeadLetterResource.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.nitric.resource.v1.DeadLetterResource} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.nitric.resource.v1.DeadLetterResource}
 */
proto.nitric.resource.v1.DeadLetterResource.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.nitric.resource.v1.DeadLetterResource.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.nitric.resource.v1.DeadLetterResource.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.nitric.resource.v1.DeadLetterResource} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.nitric.resource.v1.DeadLetterResource.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
};
